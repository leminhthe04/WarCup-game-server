...
@ReceiveType(ReceiveMessageType.CAST_SKILL_RECEIVE)
@Component
public class CastSkillReceive implements TLVDecodable {
    String casterId;
    ...
    public void decode(byte[] value) {
        try {
            ...
            this.casterId = Util.readString(dis, Short.class);
            this.targetPosition = new Vector2(dis.readFloat(), dis.readFloat());
